...
// FAQ Data tailored for LocalAwaaz
const faqData = [
    {
        id: 1,
        category: 'General',
        question: 'What is LocalAwaaz?',
        answer: 'LocalAwaaz is a community-driven civic tech platform where citizens can report local issues (like potholes, broken streetlights, or sanitation problems), verify existing reports, and bring them to the attention of local authorities.'
    },
    {
        id: 2,
        category: 'Reporting',
        question: 'How do I report a new issue?',
        answer: 'Navigate to the "Report Issue" page from the sidebar or bottom menu. Fill in the title, detailed description, add relevant photos (up to 3), and ensure your GPS location is captured. You can also choose to post anonymously before submitting.'
    },
    {
        id: 3,
        category: 'Reporting',
        question: 'Can I report an issue without revealing my identity?',
        answer: 'Yes! When filling out the report form, simply check the "Post Anonymously" box. Your personal details and username will be hidden from the public feed, but the issue will still be recorded.'
    },
    {
        id: 4,
        category: 'General',
        question: 'What does "I Confirm" mean?',
        answer: 'If you see an issue reported in your area that you know is genuine, you can click "I Confirm". This increases the issue\'s confirmation count and impact score, making it more visible and urgent for authorities.'
    },
    {
        id: 5,
        category: 'Account',
        question: 'How is my Civil Score calculated?',
        answer: 'Your Civil Score increases when you actively participate in the community. You earn points for reporting genuine issues, having your issues confirmed by others, and verifying other people\'s reports.'
    },
    {
        id: 6,
        category: 'Privacy',
        question: 'Who can see my location?',
        answer: 'Your exact live location is never shared. Only the location of the issue you report is made public so that others can verify it and authorities can resolve it.'
    }
];

const categories = ['All', 'General', 'Reporting', 'Account', 'Privacy'];
        ...
        <div className="min-h-[100dvh] bg-texture pb-20 md:pb-8">
            ...
            <header className="glass-card sticky top-2 md:top-4 z-40 mx-2 md:mx-4 rounded-xl md:rounded-2xl shadow-sm border-b border-border/50">
                <div className="flex items-center px-4 py-3 md:px-8 md:py-5 gap-3 md:gap-4">
                    ...
                    <div>
                        <h1 className="text-lg md:text-xl font-bold text-foreground leading-tight">Help & Support</h1>
                        <p className="text-[10px] md:text-xs text-muted-foreground">Find answers or contact us</p>
                    </div>
                </div>
            </header>
            ...
            <div className="max-w-4xl mx-auto px-4 mt-6 md:mt-8">
                ...
                <div className="flex gap-2 md:gap-3 mb-8 overflow-x-auto no-scrollbar pb-2 animate-fade-in-up">
                    {categories.map((category) => (
                        <button
                            ...
                            className={`px-4 py-2 rounded-full text-xs md:text-sm font-medium whitespace-nowrap transition-all ${activeCategory === category
                ...
                <div className="mt-12 mb-6 glass-card border border-border rounded-3xl p-6 md:p-8 text-center animate-fade-in-up">
                    ...
                    <h2 className="text-lg md:text-xl font-bold text-foreground mb-2">Still need help?</h2>
