...
const IssueDetailPage = () => {
  ...
  return (
    <div className="min-h-screen bg-texture">
      {/* Header */}
      <div className="sticky top-0 z-40 glass-card border-0 border-b border-border mx-4 mt-4 rounded-lg">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-purple-500/10 rounded-xl p-5 border border-purple-500/20">
              <h3 className="text-lg font-semibold text-foreground mb-4">Reported By</h3>
