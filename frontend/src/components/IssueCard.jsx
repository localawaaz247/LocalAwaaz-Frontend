      ...
      <div className="flex justify-between items-center">
        <div className="flex gap-6 text-sm">
          <span className="text-foreground">
            <strong>{confirmationCount || 0}</strong> Confirmed
          </span>
          
          <span className="text-foreground">
            <strong>{impactScore || impact || 0}</strong> Impact
          </span>
        </div>
        ...
        <div className="flex gap-2">
          <button
            ...
            className="px-3 py-2 rounded-xl text-sm font-medium transition-all bg-red-100 text-red-700 border border-red-200 hover:bg-red-200 flex items-center gap-1"
          >
            <Flag size={14} />
            Flag
          </button>
