...
import { Calendar, CheckCircle, Flag, TrendingUp, Image as ImageIcon } from "lucide-react";
          ...
          <div className="space-y-4 max-h-[600px] overflow-y-auto thin-scrollbar pr-2">
            {displayedIssues.map((issue) => {
              ...
              return (
                <div 
                  key={issue._id} 
                  // NEW: Instantly route to dashboard and open modal!
